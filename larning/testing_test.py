...
def test_name():
    ...
    assert (
        globals()["test_basic_class.basic_classmethod_0"]
        is globals()["_basic_classmethod"]
    )
    assert (
        globals()["test_basic_class.basic_staticmethod_0"]
        is globals()["_basic_staticmethod"]
    )
    assert globals()["_basic_property_fget"] is not globals()["_basic_property_fset"]
    assert (
        globals()["_basic_property_fset"]
        is globals()["test_basic_class.basic_property_1"]
    )
